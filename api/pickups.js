...
export default async function handler(req, res) {
  await ensureSchema()
  if (req.method === 'GET') {
    const r = await pool.query('SELECT * FROM pickups')
  ...
  if (req.method === 'POST') {
    try {
      ...
      await pool.query('INSERT INTO pickups (id,request_id,date,time,contact,lat,lng,created_at) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)',
        [id, requestId, date, time, contact, lat, lng, new Date().toISOString()])
