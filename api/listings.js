...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    try {
      ...
      await pool.query('INSERT INTO listings (id,type,name,desc,img,contact,lat,lng,created_at) VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)',
        [id, type, name, desc, img, contact, lat, lng, new Date().toISOString()])
